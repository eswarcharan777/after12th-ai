...
// Gemini 2.5 Flash — current stable, fast, cheap. (1.5-flash was deprecated
// on the v1beta endpoint.) Override via GEMINI_MODEL env var on Render if you
// want to test a newer model like gemini-2.5-pro or gemini-2.5-flash-lite.
