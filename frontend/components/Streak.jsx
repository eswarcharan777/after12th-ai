...
export default function Streak() {
  ...
  return (
    <div className="glass" style={{ padding: 18, borderRadius: 14, display: 'flex', alignItems: 'center', gap: 14, position: 'relative', overflow: 'hidden' }}>
      <div style={{ position: 'absolute', top: -20, right: -20, width: 80, height: 80, borderRadius: '50%', background: '#EF4444', filter: 'blur(40px)', opacity: 0.25 }} />
      <div style={{ position: 'relative', fontSize: 38, animation: 'flicker 2.5s infinite' }}>🔥</div>
