...
export default function Dashboard() {
  ...
  const quickLinks = [
    ...
    { to: '/app/photo-doubt', icon: '📸', label: 'Photo Doubt', desc: 'Snap a question → AI solves', color: '#8B5CF6' },
    { to: '/app/voice-chat', icon: '🗣️', label: 'Voice Chat', desc: 'Full voice conversation', color: '#EC4899' },
    { to: '/app/summarize', icon: '📚', label: 'AI Summarizer', desc: 'Paste lesson → clean notes', color: '#06B6D4' },
    { to: '/app/qgen', icon: '🧪', label: 'Question Generator', desc: 'Custom mock tests on demand', color: '#F5A623' },
    { to: '/app/roadmap', icon: '🗺️', label: 'AI Roadmap', desc: 'Full personalised prep plan', color: '#10B981' },
    { to: '/app/srs', icon: '🎴', label: 'SRS Flashcards', desc: 'Anki-style spaced repetition', color: '#8B5CF6' },
    { to: '/app/adaptive', icon: '🎯', label: 'Adaptive Practice', desc: 'AI picks questions for you', color: '#EC4899' },
    { to: '/app/heatmap', icon: '📈', label: 'Weakness Heatmap', desc: 'See where to focus', color: '#EF4444' },
    { to: '/app/mindmap', icon: '🎨', label: 'Mind Maps', desc: 'Visual concept connections', color: '#06B6D4' },
    { to: '/app/cheatsheet', icon: '📝', label: 'Cheatsheet Gen', desc: 'Auto-build revision sheets', color: '#F5A623' },
    { to: '/app/highlighter', icon: '✏️', label: 'Highlighter', desc: 'Mark important text', color: '#F472B6' },
    { to: '/app/challenges', icon: '🎯', label: 'Daily Challenges', desc: 'Earn XP with daily tasks', color: '#8B5CF6' },
    { to: '/app/leaderboard', icon: '🥇', label: 'Leaderboard', desc: 'See top scorers', color: '#F5A623' },
    { to: '/app/tournament', icon: '🏆', label: 'Tournament', desc: 'Weekly compete', color: '#EC4899' },
    { to: '/app/lootbox', icon: '🎁', label: 'Loot Box', desc: 'Spend XP for rewards', color: '#06B6D4' },
    { to: '/app/pet', icon: '🐉', label: 'Study Pet', desc: 'Grows as you study', color: '#10B981' },
    { to: '/app/skilltree', icon: '📊', label: 'Skill Tree', desc: 'Unlock chapters', color: '#A78BFA' },
  ];
  ...
  return (
    <div className="page-enter">
      ...
      <Reveal variant="up"><XPBar /></Reveal>

      {/* Weekly Progress Chart */}
      <Reveal variant="up">
        <div className="glass" style={{ padding: 22, borderRadius: 16, marginBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <h3 style={{ fontFamily: 'Sora', fontWeight: 700, fontSize: 16, color: 'var(--text)' }}>📈 Weekly Progress</h3>
            <span className="badge badge-violet">This week</span>
          </div>
          <ChartLine data={[40, 55, 45, 70, 62, 82, 90]} height={140} />
        </div>
      </Reveal>
